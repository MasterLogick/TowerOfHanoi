...
public class ShaderLoader {
    private static int loadShader(InputStream stream, int shaderType) throws Exception {
    ...
    private static int linkShader(String shaderSource, int shaderType) throws Exception {
    ...
    private static Shader linkShaderProgram(int vectorShader, int fragmentShader) throws Exception {
    ...
    private static void checkProgramLinking(int program) throws Exception {
    ...
    private static void checkShaderCompilation(int shader) throws Exception {
